...
--------------------------
Script purpose:
	This stored procedure loads data into the 'silver' layer schema from the 'bronze' layer.
	It performs the following actions:
	- Truncates the silver tables before loading data.
	- Uses the 'BULK INSERT' command to load data from the bronze tables to the silver tables.
